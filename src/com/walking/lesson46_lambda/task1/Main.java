...
public class Main {
    public static void main(String[] args) {
        ...
        Comparator<Car> numberComparator = (o1, o2) -> o1.getIdentifier().getNumber().compareTo(o2.getIdentifier().getNumber());
        // Number comparing
        ...
        Comparator<Car> yearComparator = (o1, o2) -> o1.getIdentifier().getYear() - o2.getIdentifier().getYear();
